# ============================================
# TERRAFORM CONFIGURATION - EMPRESA DEV
# ============================================
# Ambiente: RedSalud DEV
...
module "cloud_run" {
  ...
  # Autoscaling (siempre activo para empresa)
  min_instances = "1"
  max_instances = "3"
  ...
  env_vars = {
    ...
    FLASK_DEBUG       = "false"
    ENABLE_IAP        = "true"
    ENABLE_DEMO_LOGIN = "true" # Empresa DEV tiene login tradicional
  }
