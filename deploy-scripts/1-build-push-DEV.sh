#!/bin/bash
# ================================================
# SCRIPT 1: BUILD Y PUSH IMAGEN DOCKER - DEV
# ================================================
...
# Variables
PROJECT_ID="dev-ticket-home-redsalud"
REGION="us-central1"
...
echo ""
echo "================================================"
echo "✅ BUILD Y PUSH COMPLETADOS - DEV"
echo "================================================"
echo ""
echo "Imagen: ${FULL_IMAGE_PATH}"
echo ""
echo "Próximo paso:"
echo "   Ejecutar deployment: ./deploy-scripts/3-deploy-DEV-normal.sh"
echo ""
